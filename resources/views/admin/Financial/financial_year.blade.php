                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm" placeholder="Financial Year" required='required' name="name">
                                        </div>
                                        <div class="form-group">
                                            <label></label>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control form-control-sm" placeholder="Organization Name" required='required' name="start_date">
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>End Date</label>
                                            <input type="date" class="form-control form-control-sm" placeholder="Organization Name" required='required' name="end_date">
                                        </div>
                                    </div>
                                </div>
                            </form>
