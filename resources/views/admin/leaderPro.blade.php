          ...
          <div class="col-lg-12">
            <div class="card card-warning card-outline">
             <div class="overlay overl d-none">
              ...
              <div class="card-body">
                <h5 class="card-title"> <u> Add New Leader Profile</u></h5>
               <br><br>
               <form id="addnew">
                @csrf
                <div class="row">
                  <div class="col-lg-3">
                    <div class="form-group">
                     ...
                     <input type="text" class="form-control" placeholder="Enter ..." required='required' name="oname" pattern="[^' ']+">
                     </div>
                  </div>
                   <div class="col-lg-3">
                    <div class="form-group">
                     <label>Father Name</label>
                     <input type="text" class="form-control" placeholder="Enter ..." required='required' name="fname" pattern="[^' ']+">
                     </div>
                   </div>
                   <div class="col-lg-3">
                    <div class="form-group">
                     <label>G.Father Name</label>
                     <input type="text" class="form-control" placeholder="Enter ..." required='required' name="gfname" pattern="[^' ']+">
                     </div>
                   </div>
                   <div class="col-lg-3">
                    <div class="form-group">
                ...
                <div class="row">
                  <div class="col-lg-3">
                    <div class="form-group">
                     ...
                     <input type="text" class="form-control" placeholder="Enter ..." required='required' name="phone">
                     </div>
                  </div>
                  <div class="col-lg-3">
                    <div class="form-group">
                     <label>Address</label>
                     <input type="text" class="form-control" placeholder="Enter ..." required='required' name="address">
                     </div>
                  </div>
                  <div class="col-lg-3">
                    <div class="form-group">
