  ...
  <nav class="main-header navbar navbar-expand-md navbar-dark navbar-navy">
    <div class="container">
      <a href="/home" class="navbar-brand">
        ...
        <span class="brand font-weight-light">Yeka Prosperity</span>
      </a>
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a href="/home" class="nav-link @if($page == 'Dashbord') active @endif">Home</a>
          </li>
      </div>
      ...
      <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
            ...
            <a href="#" class="dropdown-item">
              ...
              <div class="media">
                ...
                <div class="media-body">
                  ...
                  <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i>df</p>
                </div>
              </div>
              <!-- Message End -->
            </a>
        ...
        <li class="nav-item dropdown @if($page == 'My Profile' || $page == 'Change Password') active @endif">
          <a class="nav-link" data-toggle="dropdown" href="#">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <a href="/myprofile" class="dropdown-item @if($page == 'My Profile') active @endif">
              ...
              <div class="dropdown-divider"></div>
              <a href="/changepass" class="dropdown-item  @if($page == 'Change Password')active @endif">
